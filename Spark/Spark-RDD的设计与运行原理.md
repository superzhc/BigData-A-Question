...
![图9-10 窄依赖与宽依赖的区别](../images/图9-10-窄依赖与宽依赖的区别.jpg)
图9-10 窄依赖与宽依赖的区别
...
![图9-11根据RDD分区的依赖关系划分阶段](../images/图9-11-根据RDD分区的依赖关系划分阶段.jpg)
