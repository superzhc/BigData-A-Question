...
- [Flink](Flink/README.md)
   - [API](Flink/API/README.md)
      ...
      - [Table](Flink/API/Table.md)
   - [Checkpoint](Flink/Checkpoint.md)
   - [JobManger](Flink/JobManger.md)
   - [SavePoint](Flink/SavePoint.md)
   - [State](Flink/State.md)
   - [TaskManager](Flink/TaskManager.md)
   - [TaskSlot](Flink/TaskSlot.md)
   - [Time](Flink/Time.md)
   ...
   - [安装部署](Flink/安装部署/README.md)
      - [Flink_on_Yarn](Flink/安装部署/Flink_on_Yarn.md)
      - [Standalone](Flink/安装部署/Standalone.md)
      - [本地模式](Flink/安装部署/本地模式.md)
   - [实现Exactly-once语义](Flink/实现Exactly-once语义.md)
   - [并行度](Flink/并行度.md)
   - [广播变量](Flink/广播变量.md)
   - [序列化](Flink/序列化.md)
...
- [Hive](Hive/README.md)
   ...
   - [HiveQL](Hive/HiveQL/README.md)
      - DDL
         - [数据库](Hive/HiveQL/DDL/数据库.md)
         - [表](Hive/HiveQL/DDL/表.md)
         - [视图](Hive/HiveQL/DDL/视图.md)
      - [DML](Hive/HiveQL/DML/README.md)
         - [Hive数据导入和导出](Hive/HiveQL/DML/Hive数据导入和导出.md)
      - [HiveQL](Hive/HiveQL/HiveQL.md)
      - [Hive内置函数](Hive/HiveQL/Hive内置函数.md)
      - [Hive运算符](Hive/HiveQL/Hive运算符.md)
      - [OrderBy_SortBy_DistributeBy_ClusterBy之间的区别](Hive/HiveQL/OrderBy_SortBy_DistributeBy_ClusterBy之间的区别.md)
      - [SELECT](Hive/HiveQL/SELECT.md)
      - 窗口函数
         - [分析函数(又称窗口函数)](Hive/HiveQL/窗口函数/分析函数(又称窗口函数).md)
         - [分析窗口函数之排名分析函数](Hive/HiveQL/窗口函数/分析窗口函数之排名分析函数.md)
         - [分析窗口函数之数学分析函数](Hive/HiveQL/窗口函数/分析窗口函数之数学分析函数.md)
         - [分析窗口函数之聚合分析函数](Hive/HiveQL/窗口函数/分析窗口函数之聚合分析函数.md)
   ...
   - [Hive的Map和Reduce个数设置](Hive/Hive的Map和Reduce个数设置.md)
   - [Hive的安装配置](Hive/Hive的安装配置.md)
   - [Hive读文件时的输入任务划分](Hive/Hive读文件时的输入任务划分.md)
   - [Hive配置参数](Hive/Hive配置参数.md)
   - [Question](Hive/Question.md)
   - [Tez](Hive/Tez/README.md)
      - [安装部署](Hive/Tez/安装部署.md)
   - 实战
      - [Hive整合HBase](Hive/实战/Hive整合HBase.md)
      - [Hive日志调试](Hive/实战/Hive日志调试.md)
      - [简单查询不启用Mapreduce_job而启用Fetch_task](Hive/实战/简单查询不启用Mapreduce_job而启用Fetch_task.md)
...
- [Presto](Presto/README.md)
   ...
   - [安装部署](Presto/安装部署.md)
   - 连接器
      - [Hive](Presto/连接器/Hive.md)
      - [JMX](Presto/连接器/JMX.md)
      - [MySQL](Presto/连接器/MySQL.md)
...
- [Spark](Spark/README.md)
   ...
   - F&Q
      - [reduceByKey和groupByKey的区别](Spark/F&Q/reduceByKey和groupByKey的区别.md)
      - [SparkTask未序列化(Tasknotserializable)问题分析](Spark/F&Q/SparkTask未序列化(Tasknotserializable)问题分析.md)
      - [Spark集群中的节点个数、RDD分区个数、cpu内核个数三者与并行度的关系](Spark/F&Q/Spark集群中的节点个数、RDD分区个数、cpu内核个数三者与并行度的关系.md)
   - [FAQ](Spark/FAQ.md)
   - [Join策略](Spark/Join策略.md)
   ...
   - [SparkSQL](Spark/SparkSQL/README.md)
      - [DataFrame-Dataset创建和存储](Spark/SparkSQL/DataFrame-Dataset创建和存储.md)
      - [DataFrame-Dataset操作](Spark/SparkSQL/DataFrame-Dataset操作.md)
      - [RDD、DataFrame、DataSet相互转换](Spark/SparkSQL/RDD、DataFrame、DataSet相互转换.md)
      - [SparkSession](Spark/SparkSQL/SparkSession.md)
      - [SparkSQL工作原理](Spark/SparkSQL/SparkSQL工作原理.md)
      - [函数](Spark/SparkSQL/函数.md)
      - [自定义函数](Spark/SparkSQL/自定义函数.md)
   - [SparkStreaming](Spark/SparkStreaming/README.md)
      - [Checkpoint机制](Spark/SparkStreaming/Checkpoint机制.md)
      - [DStream](Spark/SparkStreaming/DStream.md)
      - [DStream源码分析](Spark/SparkStreaming/DStream源码分析.md)
      - [Join操作](Spark/SparkStreaming/Join操作.md)
      - [Receiver](Spark/SparkStreaming/Receiver.md)
      - [StreamingContext](Spark/SparkStreaming/StreamingContext.md)
      - [共享变量](Spark/SparkStreaming/共享变量.md)
      - [容错机制](Spark/SparkStreaming/容错机制.md)
      - [性能调优](Spark/SparkStreaming/性能调优.md)
      - [操作示例](Spark/SparkStreaming/操作示例.md)
      - [检查点Checkpoint](Spark/SparkStreaming/检查点Checkpoint.md)
      - [缓存与持久化机制](Spark/SparkStreaming/缓存与持久化机制.md)
      - [运行流程](Spark/SparkStreaming/运行流程.md)
      - [预写日志机制](Spark/SparkStreaming/预写日志机制.md)
      - [高可用](Spark/SparkStreaming/高可用.md)
   - Spark_On_YARN
      - [启动流程分析](Spark/Spark_On_YARN/启动流程分析.md)
   ...
   - [多个Job调度](Spark/多个Job调度.md)
   - [开发环境搭建](Spark/开发环境搭建.md)
   - 源码分析
      - SparkCore
         - [SparkCore-1-Overview](Spark/源码分析/SparkCore/SparkCore-1-Overview.md)
         - [SparkCore-2-JobLogicalPlan](Spark/源码分析/SparkCore/SparkCore-2-JobLogicalPlan.md)
         - [SparkCore-3-JobPhysicalPlan](Spark/源码分析/SparkCore/SparkCore-3-JobPhysicalPlan.md)
         - [SparkCore-4-shuffleDetails](Spark/源码分析/SparkCore/SparkCore-4-shuffleDetails.md)
         - [SparkCore-5-Architecture](Spark/源码分析/SparkCore/SparkCore-5-Architecture.md)
         - [SparkCore-6-CacheAndCheckpoint](Spark/源码分析/SparkCore/SparkCore-6-CacheAndCheckpoint.md)
         - [SparkCore-7-Broadcast](Spark/源码分析/SparkCore/SparkCore-7-Broadcast.md)
         - [备注](Spark/源码分析/SparkCore/备注.md)
      - SparkSQL
         - [0.Catalyst流程解析](Spark/源码分析/SparkSQL/0.Catalyst流程解析.md)
         - [1.Antlr4解析Sql并生成树](Spark/源码分析/SparkSQL/1.Antlr4解析Sql并生成树.md)
         - [2.Analysis阶段分析](Spark/源码分析/SparkSQL/2.Analysis阶段分析.md)
         - [3.Optimization阶段解析](Spark/源码分析/SparkSQL/3.Optimization阶段解析.md)
         - [4.Physical_Planning阶段解析](Spark/源码分析/SparkSQL/4.Physical_Planning阶段解析.md)
         - [5.SparkPlan准备和执行阶段](Spark/源码分析/SparkSQL/5.SparkPlan准备和执行阶段.md)
      - SparkSQL1.0.0
         - [1.SparkSQL源码分析之核心流程](Spark/源码分析/SparkSQL1.0.0/1.SparkSQL源码分析之核心流程.md)
         - [10.SparkSQL源码分析之In-Memory_Columnar_Storage源码分析之query](Spark/源码分析/SparkSQL1.0.0/10.SparkSQL源码分析之In-Memory_Columnar_Storage源码分析之query.md)
         - [11.SparkSQL源码分析之External_DataSource外部数据源](Spark/源码分析/SparkSQL1.0.0/11.SparkSQL源码分析之External_DataSource外部数据源.md)
         - [2.SparkSQL-Catalyst源码分析之SqlParser](Spark/源码分析/SparkSQL1.0.0/2.SparkSQL-Catalyst源码分析之SqlParser.md)
         - [3.SparkSQL-Catalyst源码分析之Analyzer](Spark/源码分析/SparkSQL1.0.0/3.SparkSQL-Catalyst源码分析之Analyzer.md)
         - [4.SparkSQL-Catalyst源码分析之TreeNode_Library](Spark/源码分析/SparkSQL1.0.0/4.SparkSQL-Catalyst源码分析之TreeNode_Library.md)
         - [5.SparkSQL-Catalyst源码分析之Optimizer](Spark/源码分析/SparkSQL1.0.0/5.SparkSQL-Catalyst源码分析之Optimizer.md)
         - [6.SparkSQL-Catalyst源码分析之Physical_Plan](Spark/源码分析/SparkSQL1.0.0/6.SparkSQL-Catalyst源码分析之Physical_Plan.md)
         - [7.SparkSQL-Catalyst源码分析之UDF](Spark/源码分析/SparkSQL1.0.0/7.SparkSQL-Catalyst源码分析之UDF.md)
         - [8.SparkSQL源码分析之Physical_Plan到RDD的具体实现](Spark/源码分析/SparkSQL1.0.0/8.SparkSQL源码分析之Physical_Plan到RDD的具体实现.md)
         - [9.SparkSQL源码分析之In-Memory_Columnar_Storage源码分析之cache_table](Spark/源码分析/SparkSQL1.0.0/9.SparkSQL源码分析之In-Memory_Columnar_Storage源码分析之cache_table.md)
      - SparkStreaming
         - [0.1 Spark Streaming 实现思路与模块概述](Spark/源码分析/SparkStreaming/0.1%20Spark%20Streaming%20实现思路与模块概述.md)
         - [1.1 DStream, DStreamGraph 详解](Spark/源码分析/SparkStreaming/1.1%20DStream,%20DStreamGraph%20详解.md)
         - [1.2 DStream 生成 RDD 实例详解](Spark/源码分析/SparkStreaming/1.2%20DStream%20生成%20RDD%20实例详解.md)
         - [2.1 JobScheduler, Job, JobSet 详解](Spark/源码分析/SparkStreaming/2.1%20JobScheduler,%20Job,%20JobSet%20详解.md)
         - [2.2 JobGenerator 详解](Spark/源码分析/SparkStreaming/2.2%20JobGenerator%20详解.md)
         - [3.1 Receiver 分发详解](Spark/源码分析/SparkStreaming/3.1%20Receiver%20分发详解.md)
         - [3.2 Receiver, ReceiverSupervisor, BlockGenerator, ReceivedBlockHandler 详解](Spark/源码分析/SparkStreaming/3.2%20Receiver,%20ReceiverSupervisor,%20BlockGenerator,%20ReceivedBlockHandler%20详解.md)
         - [3.3 ReceiverTraker, ReceivedBlockTracker 详解](Spark/源码分析/SparkStreaming/3.3%20ReceiverTraker,%20ReceivedBlockTracker%20详解.md)
         - [4.1 Executor 端长时容错详解](Spark/源码分析/SparkStreaming/4.1%20Executor%20端长时容错详解.md)
         - [4.2 Driver 端长时容错详解](Spark/源码分析/SparkStreaming/4.2%20Driver%20端长时容错详解.md)
         - [Q&A 什么是 end-to-end exactly-once](Spark/源码分析/SparkStreaming/Q&A%20什么是%20end-to-end%20exactly-once.md)
         - [readme](Spark/源码分析/SparkStreaming/readme.md)
   - [监控executor的jvm运行情况](Spark/监控executor的jvm运行情况.md)
   - 调优
      - [Spark性能优化](Spark/调优/Spark性能优化.md)
